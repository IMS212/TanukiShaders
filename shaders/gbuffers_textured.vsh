...
//        float Waves = 0.05 * sin(3.14 * (frameTimeCounter * WaveSpeed + VWorldPos.x/5 + VWorldPos/6)) + 0.10 * sin (frameTimeCounter * WaveSpeed + VWorldPos.x/2.5 + VWorldPos.z/10);
...
//    if (mc_Entity.x == Lava) {
//        float FractY = fract(VWorldPos.y + 0.001);
//        float Waves = 0.05 * sin(3.14 * (frameTimeCounter * WaveSpeed + VWorldPos.x/10 + VWorldPos/12)) + 0.10 * sin (frameTimeCounter * WaveSpeed + VWorldPos.x/5 + VWorldPos.z/15);
//        WaveDisplacement = clamp(Waves, -FractY, 1.0-FractY);
//        VPos.y += WaveDisplacement * WaveAmount;
//    }
//
